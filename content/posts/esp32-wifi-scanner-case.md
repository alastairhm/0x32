...
I've also uploaded the print files to MakerWorld: [Case for ESP32 Board with 1.14 Inch Screen](https://makerworld.com/en/models/3239273-case-for-esp32-board-with-1-9-inch-screen#profileId-3669923), in case it's useful to anyone else with the same board.
